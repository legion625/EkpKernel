...
public class MbomServiceImp implements MbomService {
	...
	public PartAcqRoutingStep loadPartAcqRoutingStep(String _partAcqUid, String _seq) {
		return dataService.loadPartAcqRoutingStep(_partAcqUid, _seq);
	}
	...
	public PpartSkewer loadPpartSkewer(String _uid) {
		return dataService.loadPpartSkewer(_uid);
	}
	...
	public QueryOperation<PpartSkewerQueryParam, PpartSkewer> searchPpartSkewer(
		...
		return dataService.searchPpartSkewer(_p, _existsQvMap);
	}
	...
	public List<PartCfgConj> loadPartCfgConjListByPartAcq(String _partAcqUid){
		return dataService.loadPartCfgConjListByPartAcq(_partAcqUid);
	}
	...
	public List<ProdCtl> loadProdCtlListByProd(String _prodUid){
		return dataService.loadProdCtlListByProd(_prodUid);
	}
