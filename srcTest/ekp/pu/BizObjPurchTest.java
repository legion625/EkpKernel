...
public class BizObjPurchTest extends AbstractEkpInitTest{
	...
	public void initMethod() {
		...
		target1 = new Target("puNo1", "title1", "supplierName1", "supplierBan1", PurchPerfStatus.TO_PERF, l1);
		target2 = new Target("puNo2", "title2", "supplierName2", "supplierBan2", PurchPerfStatus.PERFED, l2);
	}
	...
	public class Target {
		...
		private Target(String puNo, String title, String supplierName, String supplierBan, PurchPerfStatus perfStatus,
				long perfTime) {
			this.puNo = puNo;
			this.title = title;
