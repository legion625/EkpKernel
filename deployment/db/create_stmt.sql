...
CREATE TABLE `invt_invt_order_item` (
  ...
  `target_type_idx` tinyint(4) DEFAULT NULL,
  `target_uid` varchar(45) DEFAULT NULL,
  `target_biz_key` varchar(45) DEFAULT NULL,
...
CREATE TABLE `pu_purch_item` (
  ...
  `ref_pa` tinyint(4) DEFAULT NULL,
  `ref_pa_uid` varchar(45) DEFAULT NULL,
  `ref_pa_type_idx` tinyint(4) DEFAULT NULL,
  `qty` double DEFAULT NULL,
  `value` double DEFAULT NULL,
  `remark` varchar(200) DEFAULT NULL,
  `object_create_time` bigint(20) DEFAULT NULL,
